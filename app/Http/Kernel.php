...
//            \Illuminate\Foundation\Http\Middleware\VerifyCsrfToken::class,
    ...
    protected $routeMiddleware = [
        ...
        'h5.active'     => \Hifone\Http\Middleware\H5UserWasActive::class,
        'web.active'     => \Hifone\Http\Middleware\WebUserWasActive::class,
        'app.active'     => \Hifone\Http\Middleware\AppUserWasActive::class,
    ];
}
