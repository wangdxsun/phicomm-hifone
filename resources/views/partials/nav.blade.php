    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navbar-default">
      ...
      @endif
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          @else
          <li {!! set_active('phicomm/register') !!}><a href="{!! url('phicomm/register') !!}" id="signup-btn">{!! trans('hifone.signup') !!}</a></li>
              <li {!! set_active('phicomm/login') !!}><a href="{!! url('phicomm/login') !!}" id="login-btn">{!! trans('hifone.login.login') !!}</a></li>
          @endif
        </ul>
      </div>
    </nav>
